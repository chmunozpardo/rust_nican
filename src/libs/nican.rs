...
#[test]
fn bindgen_test_layout_NCTYPE_UINT64() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_UINT64>(),
        8usize,
        concat!("Size of: ", stringify!(NCTYPE_UINT64))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_UINT64>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_UINT64))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_UINT64>())).LowPart as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_UINT64),
            "::",
            stringify!(LowPart)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_UINT64>())).HighPart as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_UINT64),
...
#[test]
fn bindgen_test_layout_NCTYPE_CAN_FRAME() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_CAN_FRAME>(),
        14usize,
        concat!("Size of: ", stringify!(NCTYPE_CAN_FRAME))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_CAN_FRAME>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_CAN_FRAME))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME>())).ArbitrationId as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME),
            "::",
            stringify!(ArbitrationId)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME>())).IsRemote as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME>())).DataLength as *const _ as usize },
        5usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME>())).Data as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME),
...
#[test]
fn bindgen_test_layout_NCTYPE_CAN_FRAME_TIMED() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_CAN_FRAME_TIMED>(),
        22usize,
        concat!("Size of: ", stringify!(NCTYPE_CAN_FRAME_TIMED))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_CAN_FRAME_TIMED>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_CAN_FRAME_TIMED))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_CAN_FRAME_TIMED>())).Timestamp as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME_TIMED),
            "::",
            stringify!(Timestamp)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_CAN_FRAME_TIMED>())).ArbitrationId as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME_TIMED>())).IsRemote as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME_TIMED),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_CAN_FRAME_TIMED>())).DataLength as *const _ as usize
        },
        13usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_FRAME_TIMED>())).Data as *const _ as usize },
        14usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_FRAME_TIMED),
...
#[test]
fn bindgen_test_layout_NCTYPE_CAN_STRUCT() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_CAN_STRUCT>(),
        22usize,
        concat!("Size of: ", stringify!(NCTYPE_CAN_STRUCT))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_CAN_STRUCT>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_CAN_STRUCT))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_STRUCT>())).Timestamp as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_STRUCT),
            "::",
            stringify!(Timestamp)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_STRUCT>())).ArbitrationId as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_STRUCT),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_STRUCT>())).FrameType as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_STRUCT),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_STRUCT>())).DataLength as *const _ as usize },
        13usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_STRUCT),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_STRUCT>())).Data as *const _ as usize },
        14usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_STRUCT),
...
#[test]
fn bindgen_test_layout_NCTYPE_CAN_DATA() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_CAN_DATA>(),
        8usize,
        concat!("Size of: ", stringify!(NCTYPE_CAN_DATA))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_CAN_DATA>(),
        1usize,
        concat!("Alignment of ", stringify!(NCTYPE_CAN_DATA))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_DATA>())).Data as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_DATA),
            "::",
            stringify!(Data)
        )
    );
...
#[test]
fn bindgen_test_layout_NCTYPE_CAN_DATA_TIMED() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_CAN_DATA_TIMED>(),
        16usize,
        concat!("Size of: ", stringify!(NCTYPE_CAN_DATA_TIMED))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_CAN_DATA_TIMED>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_CAN_DATA_TIMED))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_DATA_TIMED>())).Timestamp as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_DATA_TIMED),
            "::",
            stringify!(Timestamp)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<NCTYPE_CAN_DATA_TIMED>())).Data as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_CAN_DATA_TIMED),
...
#[test]
fn bindgen_test_layout_nctTypeTimestamp() {
    assert_eq!(
        ::std::mem::size_of::<nctTypeTimestamp>(),
        8usize,
        concat!("Size of: ", stringify!(nctTypeTimestamp))
    );
    assert_eq!(
        ::std::mem::align_of::<nctTypeTimestamp>(),
        2usize,
        concat!("Alignment of ", stringify!(nctTypeTimestamp))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeTimestamp>())).LowPart as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeTimestamp),
            "::",
            stringify!(LowPart)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeTimestamp>())).HighPart as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeTimestamp),
...
#[test]
fn bindgen_test_layout_nctTypeMessageConfig() {
    assert_eq!(
        ::std::mem::size_of::<nctTypeMessageConfig>(),
        12usize,
        concat!("Size of: ", stringify!(nctTypeMessageConfig))
    );
    assert_eq!(
        ::std::mem::align_of::<nctTypeMessageConfig>(),
        2usize,
        concat!("Alignment of ", stringify!(nctTypeMessageConfig))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeMessageConfig>())).MsgArbitrationID as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeMessageConfig),
            "::",
            stringify!(MsgArbitrationID)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeMessageConfig>())).MsgDataBytes as *const _ as usize
        },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeMessageConfig),
            "::",
            stringify!(MsgDataBytes)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeMessageConfig>())).Extended as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeMessageConfig),
...
#[test]
fn bindgen_test_layout_nctTypeChannelConfig() {
    assert_eq!(
        ::std::mem::size_of::<nctTypeChannelConfig>(),
        120usize,
        concat!("Size of: ", stringify!(nctTypeChannelConfig))
    );
    assert_eq!(
        ::std::mem::align_of::<nctTypeChannelConfig>(),
        2usize,
        concat!("Alignment of ", stringify!(nctTypeChannelConfig))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).StartBit as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
            "::",
            stringify!(StartBit)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).NumBits as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).DataType as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).ByteOrder as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfig>())).ScalingFactor as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
            "::",
            stringify!(ScalingFactor)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfig>())).ScalingOffset as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
            "::",
            stringify!(ScalingOffset)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).MaxValue as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).MinValue as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfig>())).DefaultValue as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfig>())).Unit as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfig),
...
#[test]
fn bindgen_test_layout_nctTypeModeChanConfig() {
    assert_eq!(
        ::std::mem::size_of::<nctTypeModeChanConfig>(),
        20usize,
        concat!("Size of: ", stringify!(nctTypeModeChanConfig))
    );
    assert_eq!(
        ::std::mem::align_of::<nctTypeModeChanConfig>(),
        2usize,
        concat!("Alignment of ", stringify!(nctTypeModeChanConfig))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeModeChanConfig>())).ModeValue as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeModeChanConfig),
            "::",
            stringify!(ModeValue)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeModeChanConfig>())).StartBit as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeModeChanConfig),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeModeChanConfig>())).NumBits as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeModeChanConfig),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeModeChanConfig>())).ByteOrder as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeModeChanConfig),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeModeChanConfig>())).DefaultValue as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_nctTypeChannelConfigMDM() {
    assert_eq!(
        ::std::mem::size_of::<nctTypeChannelConfigMDM>(),
        144usize,
        concat!("Size of: ", stringify!(nctTypeChannelConfigMDM))
    );
    assert_eq!(
        ::std::mem::align_of::<nctTypeChannelConfigMDM>(),
        2usize,
        concat!("Alignment of ", stringify!(nctTypeChannelConfigMDM))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).StartBit as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfigMDM),
            "::",
            stringify!(StartBit)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).NumBits as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfigMDM),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).DataType as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).ByteOrder as *const _ as usize
        },
        12usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).ScalingFactor as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).ScalingOffset as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).MaxValue as *const _ as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).MinValue as *const _ as usize
        },
        40usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).DefaultValue as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).Unit as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfigMDM),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).NumModeChannels as *const _ as usize
        },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(nctTypeChannelConfigMDM),
            "::",
            stringify!(NumModeChannels)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<nctTypeChannelConfigMDM>())).ModeChannel as *const _ as usize
        },
        124usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_NCTYPE_DNET_EXPL_MSG_READ() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_DNET_EXPL_MSG_READ>(),
        244usize,
        concat!("Size of: ", stringify!(NCTYPE_DNET_EXPL_MSG_READ))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_DNET_EXPL_MSG_READ>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_DNET_EXPL_MSG_READ))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_READ>())).ServiceCode as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_DNET_EXPL_MSG_READ),
            "::",
            stringify!(ServiceCode)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_READ>())).ServDataLength as *const _
                as usize
        },
        2usize,
        concat!(
            ...
            stringify!(NCTYPE_DNET_EXPL_MSG_READ),
            "::",
            stringify!(ServDataLength)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_READ>())).ServData as *const _ as usize
        },
        4usize,
        concat!(
            "Offset of field: ",
...
#[test]
fn bindgen_test_layout_NCTYPE_DNET_EXPL_MSG_WRITE() {
    assert_eq!(
        ::std::mem::size_of::<NCTYPE_DNET_EXPL_MSG_WRITE>(),
        248usize,
        concat!("Size of: ", stringify!(NCTYPE_DNET_EXPL_MSG_WRITE))
    );
    assert_eq!(
        ::std::mem::align_of::<NCTYPE_DNET_EXPL_MSG_WRITE>(),
        2usize,
        concat!("Alignment of ", stringify!(NCTYPE_DNET_EXPL_MSG_WRITE))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_WRITE>())).ServiceCode as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(NCTYPE_DNET_EXPL_MSG_WRITE),
            "::",
            stringify!(ServiceCode)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_WRITE>())).ClassId as *const _ as usize
        },
        2usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_WRITE>())).InstanceId as *const _ as usize
        },
        4usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_WRITE>())).ServDataLength as *const _
                as usize
        },
        6usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<NCTYPE_DNET_EXPL_MSG_WRITE>())).ServData as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
